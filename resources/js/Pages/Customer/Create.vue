            ...
            <form @submit.prevent="createCustomer">
                <div class="grid grid-cols-4 gap-5 items-center justify-center px-4 py-5 rounded-xl bg-slate-100 shadow">
                    ...
                    <input class="rounded-lg shadow px-5 py-2 w-full col-span-2" type="email" v-model="form.email"
                        placeholder="E-posta" />
                    <input class="rounded-lg shadow px-5 py-2 w-full col-span-2" type="tel" v-model="form.phone"
                        placeholder="Telefon" />
                    <input class="rounded-lg shadow px-5 py-2 w-full col-span-4" type="text" v-model="form.address"
                        placeholder="Adres" />
                </div>
